...
class Globals
{
	...
	public static int LeftClickMethod = 0; // ForceRelativeMouseMode ? Mouse.LEFT_CLICK_WITH_TAP_OR_TIMEOUT : Mouse.LEFT_CLICK_NORMAL;
	...
	public static int RightClickMethod = 0; // AppNeedsTwoButtonMouse ? Mouse.RIGHT_CLICK_WITH_MULTITOUCH : Mouse.RIGHT_CLICK_NONE;
	...
	public static int ShowScreenUnderFinger = 0; // Mouse.ZOOM_NONE;
